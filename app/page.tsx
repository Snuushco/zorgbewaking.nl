...
export const metadata: Metadata = {
  alternates: { canonical: "https://zorgbewaking.nl" },
};
...
export default function Home() {
  return (
    <>
      {/* Hero */}
      <section className="relative overflow-hidden bg-[#062421] text-white">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_14%_18%,rgba(94,234,212,.28),transparent_28%),radial-gradient(circle_at_86%_10%,rgba(255,255,255,.18),transparent_26%),linear-gradient(135deg,#04201d,#0f766e_52%,#07312d)]" />
        <div className="absolute inset-0 opacity-[0.18] bg-[linear-gradient(rgba(255,255,255,.22)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,.18)_1px,transparent_1px)] bg-[size:44px_44px]" />
        <div className="absolute right-[-10vw] top-24 h-[34rem] w-[34rem] rounded-[3rem] border border-white/15 bg-white/5 rotate-12" />
        <div className="relative max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 py-24 lg:py-36">
          <div className="max-w-4xl">
            <div className="inline-flex items-center gap-2 border border-white/20 bg-white/10 backdrop-blur-md px-4 py-2 rounded-2xl text-sm mb-8 shadow-2xl shadow-teal-950/20">
              <span className="w-2 h-2 bg-rose-300 rounded-full animate-pulse shadow-[0_0_18px_rgba(253,164,175,.9)]" />
              Sectorfocus zorg · de-escalatie · vaste protocollen
            </div>
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black leading-[0.94] tracking-[-0.055em] mb-7">
              Zorgbeveiliging<br />
              <span className="text-teal-200">met zorginzicht</span>
            </h1>
            <p className="text-lg sm:text-xl text-teal-50/90 leading-relaxed mb-10 max-w-2xl border-l border-teal-200/40 pl-5">
              Professionele beveiligers die zorgcontext, de-escalatie en protocollen begrijpen — met respect voor patiënten, bewoners, bezoekers en medewerkers.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                href="#contact"
                className="px-8 py-4 bg-white text-teal-950 font-black rounded-2xl hover:bg-teal-50 transition-all text-center shadow-2xl shadow-teal-950/25 hover:-translate-y-0.5"
              >
                Gratis intakegesprek →
              </Link>
              <Link
                href="/diensten/ziekenhuisbeveiliging"
                className="px-8 py-4 border border-white/30 bg-white/10 backdrop-blur-md text-white font-semibold rounded-2xl hover:bg-white/15 transition-all text-center"
              >
